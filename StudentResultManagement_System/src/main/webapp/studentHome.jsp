...
<%
   ...
   ResultSet rs=con.s.executeQuery("select* from student inner join result where student.rollNo=result.rollNo and student.rollNo='"+rollNo+"'");
   
   if(rs.next()){
   %>
<img src="logo.png"  align="left"width="150" height="150">
<center><img src="images/ssld.jpg" width="150" height="150">
...
Designed & Developed by BTech Days Team</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ BTech Days :: 2017-2021</h6></center> 
  <hr class="new1">
</body>
<% }
else{
